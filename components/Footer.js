  ...
  return (
     <div className="bg-amber-800 flex flex-col lg:flex lg:flex-row justify-center items-center h-[100vh-100px]">
      <div className="relative flex basis-1/3 justify-center">
       ...
       <div className="mb-2 justify-center items-center lg:flex lg:flex-row space-x-2 text-xs text-slate-50 dark:text-gray-400 md:text-sm lg:text-lg xl:text-xl">
        <div className="font-mono">{`© ${new Date().getFullYear()}`}</div>
        <div className='hidden md:block'>{` • `}</div>
          <p className="font-mono">all rights by:</p><br/>
          <div className="font-sans text-xs font-extrabold text-yellow-300 lg:text-lg xl:text-xl">{siteMetadata.author}</div>
      ...
      <div className='mt-3'>
          ...
          <div className="flex flex-col justify-center items-center md:flex md:flex-row md:jusify-center md:items-center">
          <Ganter className="inline lg:w-36 lg:h-12"></Ganter>
          <Astra className="inline mb-3  lg:w-36 lg:h-12"></Astra>
          <LogoLeckerladen className="mb-3 ml:8 lg:w-36 lg:h-12"></LogoLeckerladen>
          </div>
