    ...
    <>
      ...
      <section className=" mx-auto bg-slate-800 border-t-4 border-bg-amber-500 px-2 pt-5 md:px-0">
        <div className="container mx-auto max-w-7xl items-center rounded-2xl bg-green-100/10 px-8 xl:p-3">
          ...
          <div className="container mx-auto mt-6 mb-12 w-48 max-w-sm items-center border border-gray-50 px-5 py-4 text-center shadow-2xl shadow-gray-400 lg:max-w-xl">
          ...
          <p className="headingc mt-1 text-center text-5xl text-gray-50 md:text-7xl lg:text-9xl">
            WOHIN?
          </p>
